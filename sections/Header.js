...
const Header = () => {
  ...
  return (
    <header
      className={
        color
          ? "flex text-black sticky top-0 z-50 transition duration-500 ease-in-out items-center justify-between bg-white shadow-lg h-20 px-10 py-4"
          : "flex text-white sticky top-0 z-50 transition duration-500 ease-in-out items-center justify-between bg-primary h-20 px-5 md:px-10 py-4"
      }
    >
      <div className="flex justify-center items-center gap-5 md:gap-10">
        <svg
          className="h-[1.5rem] md:h-[1.8rem]"
      ...
      <div className="hidden md:flex justify-center items-center space-x-5">
        ...
        <button className="flex justify-center items-center gap-3 rounded-full border border-white py-1 px-5">
          <div>
